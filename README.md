...
| <a name="input_disk_queue_depth_sns_topics_arns"></a> [disk\_queue\_depth\_sns\_topics\_arns](#input\_disk\_queue\_depth\_sns\_topics\_arns) | List of ARNs for the SNS topics | `list(string)` | `[]` | no |
...
| <a name="input_high_connections_sns_topics_arns"></a> [high\_connections\_sns\_topics\_arns](#input\_high\_connections\_sns\_topics\_arns) | List of ARNs for the SNS topics | `list(string)` | `[]` | no |
...
| <a name="input_high_local_storage_sns_topics_arns"></a> [high\_local\_storage\_sns\_topics\_arns](#input\_high\_local\_storage\_sns\_topics\_arns) | List of ARNs for the SNS topics | `list(string)` | `[]` | no |
...
| <a name="input_high_read_latency_sns_topics_arns"></a> [high\_read\_latency\_sns\_topics\_arns](#input\_high\_read\_latency\_sns\_topics\_arns) | List of ARNs for the SNS topics | `list(string)` | `[]` | no |
...
| <a name="input_high_storage_space_sns_topics_arns"></a> [high\_storage\_space\_sns\_topics\_arns](#input\_high\_storage\_space\_sns\_topics\_arns) | List of ARNs for the SNS topics | `list(string)` | `[]` | no |
...
| <a name="input_high_write_latency_sns_topics_arns"></a> [high\_write\_latency\_sns\_topics\_arns](#input\_high\_write\_latency\_sns\_topics\_arns) | List of ARNs for the SNS topics | `list(string)` | `[]` | no |
| <a name="input_swap_usage_enabled"></a> [swap\_usage\_enabled](#input\_swap\_usage\_enabled) | Enable swap usage alarm | `bool` | `true` | no |
| <a name="input_swap_usage_sns_topics_arns"></a> [swap\_usage\_sns\_topics\_arns](#input\_swap\_usage\_sns\_topics\_arns) | List of ARNs for the SNS topics | `list(string)` | `[]` | no |
