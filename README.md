...
module "rds_alarms" {
  source = "delivops/rds-alerts/aws"
  #version            = "0.0.1"
...
| <a name="input_high_storage_enabled"></a> [high_storage_enabled](#input_high_storage_enabled)                   | Enable high storage alarm                                              | `bool`        | `true`      |    no    |
| <a name="input_high_storage_threshold"></a> [high_storage_threshold](#input_high_storage_threshold)             | The threshold for high storage usage                                   | `number`      | `90`        |    no    |
...
| <a name="input_swap_usage_threshold_bytes"></a> [swap_usage_threshold_bytes](#input_swap_usage_threshold_bytes) | The threshold for swap usage                                           | `number`      | `256000000` |    no    |
